...
fprintf(1,'Time for FMM01_apply        = %11.6f    (nr of RHS = %d)\n',sum(t_vec),nrhs)
fprintf(1,'              T_ofs         = %11.6f    (=%5.1f%%)\n',t_vec(1),100*t_vec(1)/sum(t_vec))
fprintf(1,'              T_ofo         = %11.6f    (=%5.1f%%)\n',t_vec(2),100*t_vec(2)/sum(t_vec))
fprintf(1,'              List 1        = %11.6f    (=%5.1f%%)\n',t_vec(3),100*t_vec(3)/sum(t_vec))
fprintf(1,'              List 2        = %11.6f    (=%5.1f%%)\n',t_vec(4),100*t_vec(4)/sum(t_vec))
fprintf(1,'              List 3        = %11.6f    (=%5.1f%%)\n',t_vec(5),100*t_vec(5)/sum(t_vec))
fprintf(1,'              List 4        = %11.6f    (=%5.1f%%)\n',t_vec(6),100*t_vec(6)/sum(t_vec))
fprintf(1,'              T_ifi         = %11.6f    (=%5.1f%%)\n',t_vec(7),100*t_vec(7)/sum(t_vec))
fprintf(1,'              T_tfi         = %11.6f    (=%5.1f%%)\n',t_vec(8),100*t_vec(8)/sum(t_vec))
fprintf(1,'              Leaf self-int = %11.6f    (=%5.1f%%)\n',t_vec(9),100*t_vec(9)/sum(t_vec))
